...
// v1.3.1 perf fix: cache in memory - every device on the WiFi polls
// this every 15s (public/js/airdrop.js), which used to mean a
// synchronous disk read per device per poll. This process is the only
// writer, so the cache stays accurate.
let cache = null;
