...
// v1.3.1 perf fix: cache in memory - download progress is polled every
// 1s while a job is running (public/js/ytdownload.js), which used to
// mean a synchronous disk read on every poll on top of the actual
// yt-dlp child process work already loading the CPU. This process is
// the only writer.
let cache = null;
